...
module riscv_core (
    ...
    output wire [31:0] imem_address_out, 
    ...
    assign imem_address_out = curr_pc;
    ...
    ins_decode decode_stage (
        ...
        .ex_mem_read_in(ex_mem_read_in),
        .ex_reg_write_in(ex_reg_write_in),
    ...
    id_ex_buffer id_ex (
        ...
        .id_mem_to_reg_in(id_mem_to_reg_out),
        .id_alu_src_in(id_alu_src_out),
        .id_branch_in(id_branch_out),
        .id_alu_ctrl_in(id_alu_ctrl_out),
        .id_write_from_pc_in(id_write_from_pc_out),
        ...
        .ex_mem_to_reg_out(ex_mem_to_reg_in),
        .ex_alu_src_out(ex_alu_src_in),
        .ex_branch_out(ex_branch_in),
        .ex_alu_ctrl_out(ex_alu_ctrl_in),
        .ex_write_from_pc_out(ex_write_from_pc_in)
    );
